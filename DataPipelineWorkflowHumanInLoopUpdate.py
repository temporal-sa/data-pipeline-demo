...
@workflow.defn
class DataPipelineWorkflowHumanInLoopUpdate:
    ...
    async def run(self, input: DataPipelineParams) -> str:
        ...
        try:
            ...
            workflow.logger.info(f"Received update that load completed: {input.input_filename} load complete: {self.load_complete}")
